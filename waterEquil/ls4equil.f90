...
!         print*, '** OUTPUT FILES= '
        ...
        open(unit=85, file="atomic_dipole.out")
        open(unit=69, file="total_dipole.out")
        open(unit=100,file="charges.out")
...
!         rat(10,1,2)=rat(10,1,2)+0.0005d0
        ...
        dt=0.0002d-12
        fkb= 1.3806503d-23
        fmasso=15.9994d0*1.6605402D-27 !convert to AMU
        fmassh=1.d0*1.6605402D-27      !convert to AMU
        fmass1(1)=fmasso
        fmass1(2)=fmassh
        fmass1(3)=fmassh
...
!            stop
        ...
        do i=1,nmol
          do ia=1,3
            ...
            write(85, *) dipole(i,i_a,1), dipole(i,i_a,2), dipole(i,i_a,3) !atomic dipole
          enddo
        enddo

        do i=1,nmol
          write(100, *) qat(1,i), qat(2,i), qat(3,i)
        enddo
